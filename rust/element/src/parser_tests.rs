...
mod footnote_definition {
    ...
    fn back_to_back_footnotes_are_siblings_not_nested() {
        ...
        assert_eq!(data1.value, "First footnote content", "first footnote value");
        assert_eq!(data2.value, "Second footnote content", "second footnote value");
    ...
    fn footnote_before_headline_is_not_nested() {
        ...
        let Syntax::Headline(_) = &arena[headline].data else {
            panic!("second root child should be Headline, got: {:?}", arena[headline].data);
        };
    }
}
