...
impl<'a> EntityData<'a> {
    ...
    pub fn new(name: &'a str) -> Option<Self> {
        ...
        let (ascii, html, latex, latex_math_p, latin1, utf_8) = match name {
            ...
            "Dagger" => ("[doubledagger]", "&Dagger;", "\\textdaggerdbl{}", false, "[doubledagger]", "‡"),
            "Delta" => ("Delta", "&Delta;", "\\Delta", true, "Delta", "Δ"),
            "Diamond" => ("[diamond]", "&diamond;", "\\diamondsuit", true, "[diamond]", "◆"),
            "Downarrow" => ("[dbldownarrow]", "&dArr;", "\\Downarrow", true, "[dbldownarrow]", "⇓"),
            ...
            "Uparrow" => ("[dbluparrow]", "&uArr;", "\\Uparrow", true, "[dbluparrow]", "⇑"),
            ...
            "approx" => ("[almost equal to]", "&asymp;", "\\approx", true, "[almost equal to]", "≈"),
            ...
            "ast" => ("*", "&lowast;", "\\ast", true, "*", "*"),
            "asymp" => ("[almost equal to]", "&asymp;", "\\asymp", true, "[almost equal to]", "≈"),
            "atilde" => ("a", "&atilde;", "\\~{a}", false, "ã", "ã"),
            "auml" => ("ae", "&auml;", "\\\"{a}", false, "ä", "ä"),
            "bdquo" => ("\"", "&bdquo;", "\\quotedblbase{}", false, "\"", "„"),
            "because" => ("[because]", "&because;", "\\because", true, "[because]", "∵"),
            ...
            "cap" => ("[intersection]", "&cap;", "\\cap", true, "[intersection]", "∩"),
            "ccedil" => ("c", "&ccedil;", "\\c{c}", false, "ç", "ç"),
            "cdots" => ("...", "&ctdot;", "\\cdots{}", true, "...", "⋯"),
            "cedil" => ("[cedilla]", "&cedil;", "\\c{}", false, "¸", "¸"),
            "cent" => ("cent", "&cent;", "\\textcent{}", false, "¢", "¢"),
            "check" => ("[checkmark]", "&checkmark;", "\\checkmark", true, "[checkmark]", "✓"),
            "checkmark" => ("[checkmark]", "&check;", "\\checkmark", true, "[checkmark]", "✓"),
            "circ" => ("^", "&circ;", "\\^{}", false, "^", "∘"),
            "clubs" => ("[clubs]", "&clubs;", "\\clubsuit", true, "[clubs]", "♣"),
            "clubsuit" => ("[clubs]", "&clubs;", "\\clubsuit", true, "[clubs]", "♣"),
            "colon" => (":", ":", "\\colon", true, ":", ":"),
            "cong" => ("[approx. equal to]", "&cong;", "\\cong", true, "[approx. equal to]", "≅"),
            ...
            "dArr" => ("[dbldownarrow]", "&dArr;", "\\Downarrow", true, "[dbldownarrow]", "⇓"),
            "dag" => ("[dagger]", "&dagger;", "\\dag{}", false, "[dagger]", "†"),
            "dagger" => ("[dagger]", "&dagger;", "\\textdagger{}", false, "[dagger]", "†"),
            "dalet" => ("dalet", "&daleth;", "\\daleth", true, "dalet", "ד"),
            "darr" => ("[downarrow]", "&darr;", "\\downarrow", true, "[downarrow]", "↓"),
            "ddag" => ("[doubledagger]", "&Dagger;", "\\ddag{}", false, "[doubledagger]", "‡"),
            "det" => ("det", "det", "\\det", true, "det", "det"),
            "diamond" => ("[diamond]", "&diamond;", "\\diamondsuit", true, "[diamond]", "◆"),
            "diamondsuit" => ("[diamonds]", "&diams;", "\\diamondsuit", true, "[diamonds]", "◆"),
            "diams" => ("[diamonds]", "&diams;", "\\diamondsuit", true, "[diamonds]", "◆"),
            "dim" => ("dim", "dim", "\\dim", true, "dim", "dim"),
            "div" => ("/", "&divide;", "\\textdiv{}", false, "÷", "÷"),
            "dollar" => ("$", "$", "\\$", false, "$", "$"),
            "dots" => ("...", "&hellip;", "\\dots{}", false, "...", "…"),
            "downarrow" => ("[downarrow]", "&darr;", "\\downarrow", true, "[downarrow]", "↓"),
            "eacute" => ("e", "&eacute;", "\\'{e}", false, "é", "é"),
            "ecirc" => ("e", "&ecirc;", "\\^{e}", false, "ê", "ê"),
            "egrave" => ("e", "&egrave;", "\\`{e}", false, "è", "è"),
            "ell" => ("ell", "&ell;", "\\ell", true, "ell", "ℓ"),
            "empty" => ("[empty set]", "&empty;", "\\emptyset", true, "[empty set]", "∅"),
            "emptyset" => ("[empty set]", "&empty;", "\\emptyset", true, "[empty set]", "∅"),
            "emsp" => (" ", "&emsp;", "\\hspace*{1em}", false, " ", "\u{2003}"),
            "ensp" => (" ", "&ensp;", "\\hspace*{.5em}", false, " ", "\u{2002}"),
            "equal" => ("=", "=", "=", false, "=", "="),
            "equiv" => ("[identical to]", "&equiv;", "\\equiv", true, "[identical to]", "≡"),
            "eth" => ("dh", "&eth;", "\\dh{}", false, "ð", "ð"),
            "euml" => ("e", "&euml;", "\\\"{e}", false, "ë", "ë"),
            "euro" => ("EUR", "&euro;", "\\texteuro{}", false, "EUR", "€"),
            "exist" => ("[there exists]", "&exist;", "\\exists", true, "[there exists]", "∃"),
            "exists" => ("[there exists]", "&exist;", "\\exists", true, "[there exists]", "∃"),
            ...
            "frasl" => ("/", "&frasl;", "/", false, "/", "⁄"),
            "frown" => ("[Cap product]", "&frown;", "\\frown", true, "[cap product]", "⌢"),
            ...
            "heartsuit" => ("[hearts]", "&heartsuit;", "\\heartsuit", true, "[hearts]", "♥"),
            ...
            "land" => ("[logical and]", "&and;", "\\land", true, "[logical and]", "∧"),
            "lang" => ("<", "&lang;", "\\langle", true, "<", "⟨"),
            "langle" => ("<", "&lang;", "\\langle", true, "<", "⟨"),
            "laquo" => ("<<", "&laquo;", "\\guillemotleft{}", false, "«", "«"),
            "larr" => ("<-", "&larr;", "\\leftarrow", true, "<-", "←"),
            "lceil" => ("[left ceiling]", "&lceil;", "\\lceil", true, "[left ceiling]", "⌈"),
            "ldquo" => ("\"", "&ldquo;", "\\textquotedblleft{}", false, "\"", "“"),
            "lesseqgtr" => ("[less than or equal or greater than or equal]", "&lesseqgtr;", "\\lesseqgtr", true, "[less than or equal or greater than or equal]", "⋚"),
            "lessgtr" => ("[less than or greater than]", "&lessgtr;", "\\lessgtr", true, "[less than or greater than]", "≶"),
            "lfloor" => ("[left floor]", "&lfloor;", "\\lfloor", true, "[left floor]", "⌊"),
            ...
            "lsquo" => ("`", "&lsquo;", "\\textquoteleft{}", false, "`", "‘"),
            "lt" => ("<", "&lt;", "\\textless{}", false, "<", "<"),
            ...
            "ne" => ("[not equal to]", "&ne;", "\\ne", true, "[not equal to]", "≠"),
            "neg" => ("[angled dash]", "&not;", "\\neg{}", true, "¬", "¬"),
            "nexist" => ("[there does not exists]", "&exist;", "\\nexists", true, "[there does not  exists]", "∄"),
            "nexists" => ("[there does not exists]", "&exist;", "\\nexists", true, "[there does not  exists]", "∄"),
            "ni" => ("[contains as member]", "&ni;", "\\ni", true, "[contains as member]", "∋"),
            "not" => ("[angled dash]", "&not;", "\\textlnot{}", false, "¬", "¬"),
            "notin" => ("[not an element of]", "&notin;", "\\notin", true, "[not an element of]", "∉"),
            "nsub" => ("[not a subset of]", "&nsub;", "\\not\\subset", true, "[not a subset of", "⊄"),
            "nsup" => ("[not a superset of]", "&nsup;", "\\not\\supset", true, "[not a superset of]", "⊅"),
            "ntilde" => ("n", "&ntilde;", "\\~{n}", false, "ñ", "ñ"),
            "oacute" => ("o", "&oacute;", "\\'{o}", false, "ó", "ó"),
            "ocirc" => ("o", "&ocirc;", "\\^{o}", false, "ô", "ô"),
            ...
            "oplus" => ("[circled plus]", "&oplus;", "\\oplus", true, "[circled plus]", "⊕"),
            "ordf" => ("_a_", "&ordf;", "\\textordfeminine{}", false, "ª", "ª"),
            "ordm" => ("_o_", "&ordm;", "\\textordmasculine{}", false, "º", "º"),
            "oslash" => ("o", "&oslash;", "\\o{}", false, "ø", "ø"),
            "otilde" => ("o", "&otilde;", "\\~{o}", false, "õ", "õ"),
            "otimes" => ("[circled times]", "&otimes;", "\\otimes", true, "[circled times]", "⊗"),
            "ouml" => ("oe", "&ouml;", "\\\"{o}", false, "ö", "ö"),
            "para" => ("paragraph", "&para;", "\\P{}", false, "¶", "¶"),
            "parallel" => ("", "&parallel;", "\\parallel", true, "", ""),
            "partial" => ("[partial differential]", "&part;", "\\partial", true, "[partial differential]", "∂"),
            "permil" => ("per thousand", "&permil;", "\\textperthousand{}", false, "per thousand", "‰"),
            ...
            "preccurlyeq" => ("[precedes or equal]", "&prcue;", "\\preccurlyeq", true, "[precedes or equal]", "≼"),
            "preceq" => ("[precedes or equal]", "&prcue;", "\\preceq", true, "[precedes or equal]", "≼"),
            "prime" => ("'", "&prime;", "\\prime", true, "'", "′"),
            "prod" => ("[product]", "&prod;", "\\prod", true, "[n-ary product]", "∏"),
            "prop" => ("[proportional to]", "&prop;", "\\propto", true, "[proportional to]", "∝"),
            "propto" => ("[proportional to]", "&prop;", "\\propto", true, "[proportional to]", "∝"),
            "quot" => ("\"", "&quot;", "\\textquotedbl{}", false, "\"", "\""),
            "rArr" => ("=>", "&rArr;", "\\Rightarrow", true, "=>", "⇒"),
            "radic" => ("[square root]", "&radic;", "\\sqrt{\\,}", true, "[square root]", "√"),
            "rang" => (">", "&rang;", "\\rangle", true, ">", "⟩"),
            "rangle" => (">", "&rang;", "\\rangle", true, ">", "⟩"),
            "raquo" => (">>", "&raquo;", "\\guillemotright{}", false, "»", "»"),
            "rarr" => ("->", "&rarr;", "\\rightarrow", true, "->", "→"),
            "rceil" => ("[right ceiling]", "&rceil;", "\\rceil", true, "[right ceiling]", "⌉"),
            "rdquo" => ("\"", "&rdquo;", "\\textquotedblright{}", false, "\"", "”"),
            "real" => ("R", "&real;", "\\Re", true, "R", "ℜ"),
            "reg" => ("(r)", "&reg;", "\\textregistered{}", false, "®", "®"),
            "rfloor" => ("[right floor]", "&rfloor;", "\\rfloor", true, "[right floor]", "⌋"),
            "rlm" => ("", "&rlm;", "", false, "", "‏"),
            "rsaquo" => (">", "&rsaquo;", "\\guilsinglright{}", false, ">", "›"),
            "rsquo" => ("'", "&rsquo;", "\\textquoteright{}", false, "'", "’"),
            "sad" => (":-(", "&#9785;", "\\ddot\\frown", true, ":-(", "☹"),
            ...
            "sim" => ("~", "&sim;", "\\sim", true, "~", "∼"),
            "simeq" => ("[approx. equal to]", "&cong;", "\\simeq", true, "[approx. equal to]", "≅"),
            "sin" => ("sin", "sin", "\\sin", true, "sin", "sin"),
            "sinh" => ("sinh", "sinh", "\\sinh", true, "sinh", "sinh"),
            "slash" => ("/", "/", "/", false, "/", "/"),
            "smile" => ("[cup product]", "&smile;", "\\smile", true, "[cup product]", "⌣"),
            ...
            "sube" => ("[subset of or equal to]", "&sube;", "\\subseteq", true, "[subset of or equal to]", "⊆"),
            "subset" => ("[subset of]", "&sub;", "\\subset", true, "[subset of]", "⊂"),
            "succ" => ("[succeeds]", "&sc;", "\\succ", true, "[succeeds]", "≻"),
            "succcurlyeq" => ("[succeeds or equal]", "&sccue;", "\\succcurlyeq", true, "[succeeds or equal]", "≽"),
            "succeq" => ("[succeeds or equal]", "&sccue;", "\\succeq", true, "[succeeds or equal]", "≽"),
            ...
            "supe" => ("[superset of or equal to]", "&supe;", "\\supseteq", true, "[superset of or equal to]", "⊇"),
            "supset" => ("[superset of]", "&sup;", "\\supset", true, "[superset of]", "⊃"),
            "szlig" => ("ss", "&szlig;", "\\ss{}", false, "ß", "ß"),
            "tan" => ("tan", "tan", "\\tan", true, "tan", "tan"),
            "tanh" => ("tanh", "tanh", "\\tanh", true, "tanh", "tanh"),
            "there4" => ("[therefore]", "&there4;", "\\therefore", true, "[therefore]", "∴"),
            "therefore" => ("[therefore]", "&there4;", "\\therefore", true, "[therefore]", "∴"),
            ...
            "to" => ("->", "&rarr;", "\\to", true, "->", "→"),
            "triangleq" => ("[defined to]", "&triangleq;", "\\triangleq", true, "[defined to]", "≜"),
            "uArr" => ("[dbluparrow]", "&uArr;", "\\Uparrow", true, "[dbluparrow]", "⇑"),
            "uacute" => ("u", "&uacute;", "\\'{u}", false, "ú", "ú"),
            "uarr" => ("[uparrow]", "&uarr;", "\\uparrow", true, "[uparrow]", "↑"),
            "ucirc" => ("u", "&ucirc;", "\\^{u}", false, "û", "û"),
            "ugrave" => ("u", "&ugrave;", "\\`{u}", false, "ù", "ù"),
            "uml" => ("[diaeresis]", "&uml;", "\\textasciidieresis{}", false, "¨", "¨"),
            "under" => ("_", "_", "\\_", false, "_", "_"),
            "uparrow" => ("[uparrow]", "&uarr;", "\\uparrow", true, "[uparrow]", "↑"),
            "upsih" => ("upsilon", "&upsih;", "\\Upsilon", true, "upsilon", "ϒ"),
            "uuml" => ("ue", "&uuml;", "\\\"{u}", false, "ü", "ü"),
            "varepsilon" => ("varepsilon", "&epsilon;", "\\varepsilon", true, "varepsilon", "ε"),
            ...
            "vert" => ("", "&vert;", "\\vert{}", true, "", ""),
            "wedge" => ("[logical and]", "&and;", "\\wedge", true, "[logical and]", "∧"),
