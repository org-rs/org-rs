...
#+begin_example
Copyright (C)  2013-2026  Bernt Hansen.
...
document is created using the publishing features of =org-mode= call_org-mode-version().
...
org-mode and publishing tools used by this document.
...
Getting started with =org-mode= is really easy.  Org-mode is included in
modern versions of Emacs.  You can update to newer versions of org-mode
with packages from elpa.

I use currently use org-mode provided in the package system within emacs.
** Getting org-mode with Git                                      :noexport:
:PROPERTIES:
...
I normally track the =main= branch in the org-mode repository.
** Org-Mode Setup
:PROPERTIES:
:CUSTOM_ID: Setup
:END:
...
HOLD:h
note left of CANCELLED: Note records\nwhy it was cancelled
CANCELLED:c
WAITING --> DONE
finish --> [*]
#+end_src

#+results[65c977b33b06cee6c3a2118bfa692aca88d58f08]:
...
#+results[4d72af20e49f0447dd04c81b4c06f034a124f032]:
[[file:object.png]]
